        ...
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                ...
                <div className='col-4 p-5 mt-5 mb-5'>
                    <h4 className=''><i class="fa fa-plus-square" aria-hidden="true"></i>Account Opening</h4>
                 ...
                 <div className='col-4 p-5 mt-5 mb-5'>
                    <h4 className=''><i class="fa fa-plus-square" aria-hidden="true"></i> Kite
</h4>
                    <a href="" style={{textDecoration:"none" , lineHeight:"2.5"}}>IPO</a><br/>
                   
                    <a href="" style={{textDecoration:"none" , lineHeight:"2.5"}}>Trading FAQs
</a><br/>
                 ...
                 <div className='col-4 p-5 mt-5 mb-5'>
                    <h4 className=''><i class="fa fa-plus-square" aria-hidden="true"></i> Funds</h4>
                 ...
                 <div className='col-4 p-5 mt-5 mb-5'>
                    <h4 className=''><i class="fa fa-plus-square" aria-hidden="true"></i> Coin</h4>
